class Solution {
    ...
    */
    ...
    private void dfs(String dig, int id, StringBuilder path){
        ...
        “choices/Branching factor ^ depth × work per leaf”
        ...
        First explain how big the tree is
        Then explain what happens at leaves

        “Choices → Depth → Total paths → Work per path”
        ...
        Space complexity is O(n) for recursion stack, and O(n × kⁿ) for storing results.”
