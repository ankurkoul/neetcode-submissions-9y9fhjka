    ...
    public int carFleet(int target, int[] position, int[] speed) {
        ...
        //c
            ...
            for(Map.Entry<Integer,Integer> e: map.entrySet()){
                double newCarRemainingTimeToReach= (double)(target-e.getKey())/e.getValue();
                //if new car time is greater than current car: no merge
                if(stack.isEmpty()|| stack.peek()<newCarRemainingTimeToReach){
                    stack.push(newCarRemainingTimeToReach);
                }
